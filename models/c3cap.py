...
from .transformer import ScaledDotProductAttentionMemory, MeshedDecoder, MemoryAugmentedEncoder
from .containers import Module
from .beam_search import *  


class C3CapModel(Module): 
    def __init__(self, config):
        super(C3CapModel, self).__init__() 
        ...
        self.visual_encoder = MemoryAugmentedEncoder(N=config.n_layer, padding_idx=0) 
        self.language_decoder = MeshedDecoder(config.vocab_size) 
