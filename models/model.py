...
class TICModel(Module): 
    def __init__(self, config, return_decoder_states=False):
        ...
        self.language_decoder = Decoder(vocab_size=config.vocab_size, return_states=return_decoder_states) 
    ...
    def beam_search(self, visual, beam_size: int, out_size=1,
        ...
        self.language_decoder.return_states = False 
